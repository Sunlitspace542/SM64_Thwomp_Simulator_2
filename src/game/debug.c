...
void try_print_debug_mario_object_info(void) {
    ...
    if (m->numLives == 0) {
        ...
        print_text(55,55, "PRESS L TO RESTART");
        ...
        print_text_centered(160, 40, "YOURE NOT SUPPOSED");
        print_text_centered(160, 20, "TO BE HERE!");
    }
    else {
        print_text_centered(160, 20, "Press A B or Z to POUND!");
        print_text_centered(160, 209, "L TO RESTART");
    }
    //print_text_fmt_int(20,180,"TEMPO  %d",gSequencePlayers[SEQ_PLAYER_LEVEL].tempo);
